...
<table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class = "actions">
          <a href ="<?php echo BASE_URL ?>product/delete_category/<?php echo $cate['id_category_product'] ?>" class = "btn-delete" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')">Xóa</a>
          <a href ="<?php echo BASE_URL ?>product/edit_category/<?php echo $cate['id_category_product'] ?>" class = "btn-edit">Cập nhật</a>
        </td>
      </tr>
      <?php
        }
