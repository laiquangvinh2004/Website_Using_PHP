    ...
    <tbody>
      ...
      <tr>
        ...
        if($pro['product_hot'] == 0){
         ...
         ?></td>
        <td class = "actions">
          <a href ="<?php echo BASE_URL ?>product/delete_product/<?php echo $pro['id_product'] ?>" class = "btn-delete" onclick="return confirm('Bạn có chắc chắn muốn xóa đơn hàng này?')">Xóa</a>
          <a href ="<?php echo BASE_URL ?>product/edit_product/<?php echo $pro['id_product'] ?>" class = "btn-edit">Cập nhật</a>
        </td>
      </tr>
      <?php
        }
