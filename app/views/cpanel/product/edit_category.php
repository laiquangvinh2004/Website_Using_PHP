...
<div class="category-edit">
    <h2 class = "category-edit-title">Cập nhật danh mục sản phẩm</h2>
    ...
    <div class="form-container">
        ...
        <form action="<?php echo BASE_URL ?>/product/update_category_product/<?php echo $cate['id_category_product'] ?>" method="POST">
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $cate['title_category_product'] ?>" name="title_category_product" required>
            </div>

            <div class="form-group">
                <label>Miêu tả danh mục</label>
                <textarea name="desc_category_product" rows="5"><?php echo trim($cate['desc_category_product']) ?></textarea>
            </div>

            <div class="form-buttons">
                <button type="submit" class="btn-update">Cập nhật danh mục</button>
                <a href="<?php echo BASE_URL ?>product/list_category" class="btn-cancel">Hủy</a>
            </div>
        </form>
        <?php
        }
